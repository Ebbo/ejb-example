...
import me.ebbo.ejbremote.server.ExampleService;
...
public class EjbRemoteClient {
	...
	public static void main(String[] args) {
		...
		String ejbUrl = "ejb:/ejb-remote-server/ExampleServiceImpl!me.ebbo.ejbremote.server.ExampleService";
